...
//        public System.Timers.Timer newTimer2 = new System.Timers.Timer();
      ...
      //  newMoveEngine_Panel test = new newMoveEngine_Panel();
        public Form1()
        {
...
//
                ...
                _VLCMediaPlayer.Size = new Size(Screen.PrimaryScreen.WorkingArea.Width, Screen.PrimaryScreen.WorkingArea.Height);
        ...
        //           VLCMediaPlayer.Location = new Point(this.ClientRectangle.Location.X+8, this.ClientRectangle.Location.Y+8);
         ...
         //       }
               ...
               // VLCMediaPlayer.Location = new Point(this.ClientRectangle.Location.X, this.ClientRectangle.Location.Y);
                ...
                if (Comment_Windows.Count>0) {
                    setCommentWS(Comment_Windows, new Size(Screen.PrimaryScreen.WorkingArea.Width, Screen.PrimaryScreen.WorkingArea.Height), new Point(0, 0));
...
/*
       ...
       //    Danmoku_status.Text=e.Delta.ToString();
        ...
        public Size currentMediaWindowSize {
            ...
            get {
                Size temp = new Size(_VLCMediaPlayer.ClientSize.Width, _VLCMediaPlayer.ClientSize.Height - 40);
        ...
        void comment_windowSLsetup(List<Neo_Comment_window> l) {
            ...
            for (int i = 0; i < l.Count; i++)
            {
                l.ElementAt(i).Size = new Size(_VLCMediaPlayer.ClientSize.Width, _VLCMediaPlayer.ClientSize.Height - 45);
        ...
        {
         _VLCMediaPlayer.Size = new System.Drawing.Size(ClientRectangle.Width,ClientRectangle.Height-49);
